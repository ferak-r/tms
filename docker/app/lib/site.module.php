...
if(($_SERVER['REMOTE_ADDR']=='172.24.0.100' or substr($_SERVER['REMOTE_ADDR'], 0, 8)=='172.18.3') and strpos($_SERVER["HTTP_USER_AGENT"], 'Firefox')) {
...
ini_set('include_path', ini_get('include_path') . PATH_SEPARATOR . __DIR__ . '/pear' . PATH_SEPARATOR . __DIR__ . '/smarty/libs');
