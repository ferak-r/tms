<?php /* Smarty version 2.6.18, created on 2008-12-09 18:44:23
         compiled from container-status-all.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'regex_replace', 'container-status-all.tpl', 12, false),array('modifier', 'default', 'container-status-all.tpl', 39, false),)), $this); ?>
...
<div>
<form name="form1" id="form1" method="post" action="index.php?section=admin&module=container-status-all&cmd=update&frm_id=<?php echo $this->_tpl_vars['id']; ?>
